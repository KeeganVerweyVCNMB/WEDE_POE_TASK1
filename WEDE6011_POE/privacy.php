...
<html>
    <head>
        <title>Scuba Privacy Policy</title>
        ...
        <form action = "registration.php" method = "post">  
            ...
            <!-- (freeprivacypolicy.com. 2021.) -->
                <div class="en section_container active" section-language="en">
                    ...
                    <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The Scuba Shop, 123 Main Road, Port Elizabeth, SA.</p>
                    </li>
                    <li>
                    ...
                    <li>
                    <p><strong>Website</strong> refers to The Scuba Shop, accessible from <a href="https://www.thescubashop.co.za" rel="external nofollow noopener" target="_blank">https://www.thescubashop.co.za</a></p>
                    </li>
                    <li>
                    ...
                    <ul>
                    <li>By email: info@thescubashop.co.za</li>
                    </ul>
                    </div>
                    <div id="out_en" class="agreement_output"></div>
                    </div>

                    <button type="submit" name = "btnBackToRegister" class="btn_back col-sm-12">BACK TO REGISTER</button>     
            </div> 
        </form>
        <div class="row-spacing-reg"></div>
        </div> 
...
<?php
    if (isset($_POST['btnBackToRegister']))
    {
